...
<body class="A4 landscape">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 30px">
                    <img src="{{ asset('assets/img/logopresensi1.png') }}" width="70" height="70" alt="">
                </td>
                <td>
                    <span id="title">
                        REKAP PRESENSI KARYAWAN<br>
                        PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        PT. TELKOM WITEL BEKASI<br>
                    </span>
                    <span><i>Jl. Rw. Tembaga IV No.4, RT.006/RW.005, Marga Jaya, Kec. Bekasi Sel., Kota Bks, Jawa Barat 17141</i></span>
                </td>
            </tr>
        </table>
